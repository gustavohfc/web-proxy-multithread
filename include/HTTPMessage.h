...
enum ConnectionStatus {OK, INVALID_REQUEST, TIMEOUT, FILTER_BLOCKED, URL_BLOCKED, INVALID_TERM, CANNOT_SEND_MESSAGE_TO_HOST, CANNOT_CONNECT_TO_HOST, FAIL_CONNECT_CACHE};
